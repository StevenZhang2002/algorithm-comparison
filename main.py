...
class Test:
    ...
    def main(self):
        ...
        t = Texttable()
        t.add_rows([
            ['Algorithm', "Key Size(bits)", "Time taken in nanosecs","Memory Usage"],
...
if __name__ == "__main__":
    test1 = Test("input/usc.tiff")
    test1.main()
    Histogram.generateHistogram2("test3.jpeg","Original")
    Histogram.generateHistogram2("output/$aes_img.jpg","AES CBC MODE")
    Histogram.generateHistogram2("output/$DES_img.jpg", "DES CBC MODE")
    Histogram.generateHistogram2("output/$des3_img.jpg", "DES3 CBC MODE")
    Histogram.generateHistogram2("output/$blowfish_img.jpg", "Blowfish CBC MODE")
    Histogram.generatehistIntegrate("input/usc.tiff","output/$RC4_img.jpg","RC4")
